...
class StreamlitInterface:
    ...
    def render_unified_file_table(self):
        ...
        # Always refresh the file list when this tab is viewed
        # This ensures newly created feature files are visible
    ...
    def render_model_training(self):
        ...
        # Use the simplified Random Forest-focused interface
        ...
        try:
            ...
            with progress_container:
                ...
                if extracted_features:
                    ...
                    # Force refresh of available files for model training
                    # This ensures the newly created feature file is visible in the File Overview
                    st.info("💡 **Next Steps:** Go to Model Training tab to train models with these features.")
                    
                    # Clear the cached file info to force refresh
